...
import com.grepp.d_greppcat.http.request.RequestParser;
...
public class ServletContainer implements Runnable {
    ...
    public void run() {
        ...
        while(true) {
            ...
            } catch (IOException e) { // 이부분 추가
                throw new RuntimeException(e);
            } catch (InterruptedException | InvocationTargetException | IllegalAccessException ignored) { }
        }
    }
