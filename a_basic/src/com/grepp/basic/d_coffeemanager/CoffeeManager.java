...
public class CoffeeManager {
    ...
    private static void app() {
        ...
        // ctrl + r : 드래그 한 범위 내 일괄 수정
        // quick fix 단축키 : alt + enter > extract > method
        ...
        while (true) {
            ...
            if (menu == 1){
                ...
                if (code == 0){
                    ...
                    // 안전재고 기준선 확인
                    if (americanoSafetyStock <= americanoStock){
                        // 매입금액 산정
                        int safetyPurchasePrice = americanoSafetyStock * 2 * americanoCost;
                    ...
                    // 안전재고 기준선 확인
                    if (mochaSafetyStock <= mochaStock){
                        // 매입금액 산정
                        int safetyPurchasePrice = mochaSafetyStock * 2 * mochaCost;
                        if (balance >= safetyPurchasePrice){
                            // 매입
                            // 재고 반영
                    ...
                    // 안전재고 기준선 확인
                    if (latteSafetyStock <= latteStock){
                        // 매입금액 산정
                        int safetyPurchasePrice = latteSafetyStock * 2 * latteCost;
                        if (balance >= safetyPurchasePrice){
                            // 매입
                            // 재고 반영
