...
public class A_산술연산자 {
    ...
    public static void main(String[] args) {
        ...
        // 정수와 실수는 컴퓨터에서의 저장방식이 다르기 때문에 연산이 불가능하다.
        // 따라서 정수타입의 피연산자를 실수타입으로 형변환(casting)하여 연산을 수행
        ...
        System.out.println("=== 실수-실수 산술연산 ===");
        // float : 부동소수점 표현방식, 100.3, 0.11112
        // 순환소수, 무리수 -> 컴퓨터가 정확히 표현할 수 없음. 핧당받은 bit 수는 한정적이기 때문에
